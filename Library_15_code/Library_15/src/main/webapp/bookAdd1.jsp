...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/CSS/bookregist.css">
</head>
<body>
	...
	<form action="/Library_15/BookServlet" method="post">
		<table border="1">
			<tr>
				...
				<td><input type="text" name="isbn" id="max"></td>
				<td><button name="action" value="addsearch" class="btn-hover-20">検索</button></td>
			</tr>
		</table>
	</form>
...
<div class = non>
	...
	<form action="/Library_15/BookServlet" method="post">
			<table border="1">
				<tr>
					<th id = lable>資料名</th>
					<td><input type="text" name="title" id="max"></td>
				</tr>
				<tr>
					<th id = lable>分類名</th>
				...
				<tr>
					<th id = lable>作者</th>
					<td><input type="text" name="author" id="max"></td>
				</tr>
				<tr>
					<th id = lable>出版社</th>
					<td><input type="text" name="publisher" id="max"></td>
				</tr>
				<tr>
					<th id = lable>出版日</th>
					<td><input type="text" name="publish_date"
						placeholder="20260622(８桁)" id="ymd"></td>
				</tr>
			</table>
			<input type="hidden" name="isbn" value="${isbn }">
			<button class=btn-hover-20 name="action" value="add2">登録</button>
