...
職員のログインログアウトのメソッドをDAOで実行するためのServiceクラス(model)  
...
| # | action名 | 遷移先 | 機能 |
| :---: | :---: | :---: | :--- |
| 1 | login | top.jsp | トップページを表示 |
| 2 | logout | login.jsp | 商品カテゴリごとの商品リストを表示 |
| 3 | regist | memberResult.jsp | トップページを表示 |
| 4 | update | memberUpdate.jsp | 商品カテゴリごとの商品リストを表示 |
| 5 | cancel | memberCancel.jsp | トップページを表示 |
| 6 | search | bookSearch.jsp | 商品カテゴリごとの商品リストを表示 |
| 7 | rent | bookRr.jsp | トップページを表示 |
| 8 | add | bookAdd.jsp | 商品カテゴリごとの商品リストを表示 |
| 9 | discard | bookDiscard.jsp | トップページを表示 |
...
| # | パラメータ名 | 内容 | 備考 |
| :---: | :---: | :---: | :--- |
| 1 | action | top:トップページの表示 <br> list:商品ページの表示 | 機能を示す|
| 2 | code | 整数値 | 職員コード |
